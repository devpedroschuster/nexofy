-- Reverte 20260901123000_listar_estudios_admin_trial.sql: remove
-- trial_ends_at do retorno de listar_estudios_admin, restaurando a forma
-- anterior à PED-105. Testar contra staging antes de aplicar de verdade
-- num incidente, conforme supabase/migrations-down/README.md.
DROP FUNCTION IF EXISTS public.listar_estudios_admin(p_limit integer, p_offset integer, p_busca text);
