...
export default function LoginScreen() {
  ...
  return (
    ...
    >
      <Display style={{ fontSize: 26, marginBottom: 4 }}>Bem-vindo(a) de volta</Display>
      <Body style={{ color: '#9ca3af', marginBottom: 32 }}>Entre com seu e-mail e senha</Body>
      ...
      <Text
        style={{ color: tokens.pri, fontFamily: fonts.bodyBold, fontSize: 13, textAlign: 'center', marginTop: 24 }}
      >
        Esqueci minha senha
      </Text>
    </KeyboardAvoidingView>
