...
import { UserPlus, Users, Edit2, Ban, Trash2, Clock, MapPin, User, Hash } from 'lucide-react';
...
function DetalheAula({ evento, espacos = [] }) {
  ...
  const espacoInfo = espacos.find(e => e.slug === d.espaco);
  ...
  const rows = [
    ...
    { icon: <MapPin size={15} />, label: 'Espaço',
      value: espacoInfo?.nome || d.espaco || '—',
      icon2: espacoInfo ? <IconeEspaco nome={espacoInfo.icone} size={15} /> : null,
    },
...
export default function ModalAcoesEvento({
  ...
  return (
    <div className="space-y-4 pt-2">
      ...
      {!isAdmin && <DetalheAula evento={evento} espacos={espacos} />}
